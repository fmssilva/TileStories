...
�   �   �   �   �                                  (POIData with position, position_verified,
...
│   │   │   │   ├── POIPositionResolver.cs      ← Resolves a POI's position: uses poi.position directly
│   │   │   │   │                                  when non-null, falls back to origin (0,0,0) when null.
│   │   │   │   │                                  The position_verified flag is never consulted here.
...
�   �   �   �   �                                  "Lisboa ~1700 / Terramoto 1755 / Reconstru��o /
...
�   �   �   �   �   +-- Icons/                            ? Editor-only pencil glyph (edit-icon.png) for the
�   �   �   �   �                                                    per-POI rename button; loaded by asset path
�   �   �   �   �                                                    (EditIconAssetPath in Constants.cs).
│   │   │   │   │   ├── POIAuthoringToolWindow.PositionTabs.cs ← DrawPositionTabs (Position foldout): shows POI name + position state. When poi.position != null shows read-only XYZ + Verified toggle + Capture/Clear/Mark-Unverified buttons; when null shows hint + Capture Position button. Edit Rotation slider always visible below + ApplyPoiEditorRotation (config-driven dev-only yaw).
�   �   �   �   +-- Shared/
...
�   �       �   �                                     back path to WallConfigData.
                                  Tests POIPositionResolver: position precedence, origin fallback,
                                  NaN/Infinity rejection, unverified-but-present position is still used,
                                  and JSON round-trip semantics for position.�   �       �   +-- StatusRampTests.cs              ? Tests StatusRamp levels, threshold ordering,
