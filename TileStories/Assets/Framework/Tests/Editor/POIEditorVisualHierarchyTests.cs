...
namespace TileStories.Tests
{
    ...
    public class POIEditorVisualHierarchyTests
    {
        ...
        private static Color ReflectColor(string fieldName)
        {
            ...
            Assert.IsNotNull(fi, $"Expected private static color field '{fieldName}' on POIEditorToolWindow");
        ...
        {
            string src = ReadSource(@"Framework\Editor\POIEditor\SpecificMarker\POIEditorToolWindow.SpecificMarker.cs");
        ...
        public void Color_Constants_PoiHeaderPalette_ArrayPresent_WithAtLeastTenColors()
        {
            var fi = WindowType.GetField("PoiHeaderPalette",
                BindingFlags.NonPublic | BindingFlags.Static);
            Assert.IsNotNull(fi, "PoiHeaderPalette field should exist on POIEditorToolWindow");
