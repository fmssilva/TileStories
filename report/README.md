...
- [NOVAthesis LaTeX Template](#novathesis-latex-template)
- [Table of Contents](#table-of-contents)
- [1. Overview](#1-overview)
- [2. Key Features](#2-key-features)
    - [✔ Beginner‑Friendly](#-beginnerfriendly)
    - [✔ Expert‑Ready](#-expertready)
    - [✔ School‑Compliant](#-schoolcompliant)
...
- [4. Installation Options](#4-installation-options)
  - [4.1. Local LaTeX Installation](#41-local-latex-installation)
    - [4.1.1. Install LaTeX](#411-install-latex)
    - [4.1.2. Download NOVAthesis](#412-download-novathesis)
    - [How to download](#how-to-download)
    - [The NOVAthesis repositories](#the-novathesis-repositories)
    - [4.1.3. Compile](#413-compile)
    - [4.1.4. Configure \& Recompile](#414-configure--recompile)
...
- [12. Please give this repository a ⭐️](#12-please-give-this-repository-a-️)
- [12. Contributers (thank you!)](#12-contributers-thank-you)
- [13. Say thank you!](#13-say-thank-you)
