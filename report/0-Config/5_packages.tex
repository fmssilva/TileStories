...
\setlength{\emergencystretch}{4em} % Helps avoid overfull lines spilling into margins
\sloppy
...
\usepackage{xurl}      % Better line breaks in long URLs (e.g., bibliography entries)
\usepackage{subcaption} % Provides the subfigure environment used in Chapter 3 figures

%%% --- Gantt chart support (for Chapter 4 Work Plan) ---
\usepackage{pgfgantt}
