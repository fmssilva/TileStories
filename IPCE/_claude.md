...
Sou professor das aulas práticas do turno **P1** (2a-feira de manhã), ano letivo 2026/2027. A prática do P1 é dada **antes** da teórica da mesma matéria (que é à tarde) — por isso as coisas têm de ser explicadas de forma simples e clara para que mesmo quem não sabe nada consiga acompanhar
...
- Aula prática de 3 horas seguidas (é bom então pensar 1 intervalo maior ou 2 intervalos mais pequenos a fazer para a turma descansar) 
- Aula prática começa às 10:10
- Aula prática é dada antes da respetiva aula teórica. 
  
## Histórico de aulas:
- **Aula 1** cobriu: boas-vindas, set up (Miniconda/Spyder), primeiro contacto com Python (tipos de dados, cast, print/input), teaser de if/ciclos/funções/recursividade.
...
## Agora vamos preparar a aula 2 - Envio agora em anexo: 
...
* Envio também o guião da aula prática que é o guião que eu devo seguir na aula pratica (como vês é um guia bem feito e completo e basicamente a aula podia ser eu dizer "leiam este guia de exercícios e façam e qualquer dúvida perguntem", mas pronto, quero ser um professor de qualidade que realmente sabe ensinar e cativar a aula e ir além desses guias práticos!). 
...
- Faz-me um "Plano Guia de Sessão" sobre como eu devo explicar e/ou demonstrar e/ou mandar fazer esse guia de aula prática... 
- Faz um ficheiro `*.py`, estilo Spyder, com células `# %%` para especificar os exercícios/blocos a dar ou demonstrar e escrever aí pequenas notas do que devo dizer e ensinar, método de ensino, tempos etc. 
- Mantém linguagem deste guia de sessão concisa e simples e informal, mas bem explicado com todos os detalhes importantes. 
- Podes ter células que explicam apenas o que eu tenho de fazer durante esse bloco da aula, o que pode ser por exemplo "ler a parte X da aula e correr os exercícios a,b,c" e nem precisas tu de copiar o código do guia prático para este guia de sessão, eu depois posso copiar durante a aula. 
- Podes adicionar células ou blocos ou exeercicios ou conceitos extra ao guião da aula prática: 
